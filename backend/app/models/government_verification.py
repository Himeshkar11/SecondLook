...
class GovernmentVerification(Base):
    ...
    source: Mapped[str] = mapped_column(String(50), nullable=False)  # GST, PAN
    ...
    verification_result: Mapped[str | None] = mapped_column(String(50), nullable=True)  # VERIFIED, MISMATCH, NOT_FOUND, SOURCE_ERROR
