...
export const DEMO_VERIFICATION_RESULTS = {
  'BID-001': {
    ...
    evidenceSources: [
      { source: 'GSTN Portal (GST)', code: 'GST', status: 'VERIFIED', mode: 'DEMO', provider: 'DemoGSTProvider', identifier: '29AAACI1681G1ZV', responseTime: '0.9s', retrievedAt: '2026-09-13T10:30:00Z', data: { status: 'ACTIVE', legal_name: 'Infosys BPM Limited', taxpayer_type: 'Regular', state_jurisdiction: 'Karnataka' } },
      { source: 'Income Tax Department (PAN)', code: 'PAN', status: 'VERIFIED', mode: 'DEMO', provider: 'DemoPANProvider', identifier: 'AAACI1681G', responseTime: '1.2s', retrievedAt: '2026-09-13T10:30:01Z', data: { status: 'VALID', pan_type: 'COMPANY', masked_name: 'IN***YS BPM LTD' } },
      { source: 'Udyam MSME Registry (UDYAM)', code: 'UDYAM', status: 'VERIFIED', mode: 'DEMO', provider: 'DemoUdyamProvider', identifier: 'UDYAM-TN-00-0000001', responseTime: '1.1s', retrievedAt: '2026-09-13T10:30:01Z', data: { enterprise_type: 'Micro', major_activity: 'Services', status: 'ACTIVE' } },
      { source: 'EPFO Unified Portal (EPFO)', code: 'EPFO', status: 'VERIFIED', mode: 'DEMO', provider: 'DemoEPFOProvider', identifier: 'EPFO-DEMO-000001', responseTime: '0.8s', retrievedAt: '2026-09-13T10:30:02Z', data: { status: 'ACTIVE', establishment_status: 'ACTIVE' } },
      { source: 'ESIC Shram Suvidha (ESIC)', code: 'ESIC', status: 'VERIFIED', mode: 'DEMO', provider: 'DemoESICProvider', identifier: 'ESIC-DEMO-000001', responseTime: '0.8s', retrievedAt: '2026-09-13T10:30:02Z', data: { status: 'ACTIVE', coverage_status: 'ACTIVE' } },
      { source: 'DPIIT Startup India (STARTUP_INDIA)', code: 'STARTUP_INDIA', status: 'VERIFIED', mode: 'DEMO', provider: 'DemoStartupIndiaProvider', identifier: 'DPIIT-DEMO-000001', responseTime: '0.7s', retrievedAt: '2026-09-13T10:30:03Z', data: { status: 'ACTIVE', recognition_status: 'ACTIVE' } },
      { source: 'NSIC Single Point Registry (NSIC)', code: 'NSIC', status: 'VERIFIED', mode: 'DEMO', provider: 'DemoNSICProvider', identifier: 'NSIC-DEMO-000001', responseTime: '0.9s', retrievedAt: '2026-09-13T10:30:03Z', data: { status: 'ACTIVE', valid_until: '2027-04-12' } },
      { source: 'Make In India Local Content (MAKE_IN_INDIA)', code: 'MAKE_IN_INDIA', status: 'VERIFIED', mode: 'DEMO', provider: 'DemoMakeInIndiaProvider', identifier: 'MII-DEMO-000001', responseTime: '0.6s', retrievedAt: '2026-09-13T10:30:04Z', data: { local_content_percentage: 65.0, status: 'VERIFIED', class: 'Class-I Local Supplier' } },
      { source: 'OEM Authorization Verification (OEM)', code: 'OEM', status: 'VERIFIED', mode: 'DEMO', provider: 'DemoOEMProvider', identifier: 'OEM-DEMO-000001', responseTime: '0.7s', retrievedAt: '2026-09-13T10:30:04Z', data: { status: 'VALID', authorized_bidder: 'Infosys BPM Limited' } },
      { source: 'Central Debarment Registry (BLACKLIST)', code: 'BLACKLIST', status: 'CLEAR', mode: 'DEMO', provider: 'DemoBlacklistProvider', identifier: 'Infosys BPM Limited', responseTime: '0.5s', retrievedAt: '2026-09-13T10:30:05Z', data: { listed: false, status: 'CLEAR', restriction_reason: null } },
    ],
  },
